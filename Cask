...
(depends-on "elfeed-summary")
(depends-on "elfeed-tube")
(depends-on "elfeed-tube-mpv")
(depends-on "elpy")
...
(depends-on "pallet" :git "git@github.com:rdallasgray/pallet.git" :ref "master")
