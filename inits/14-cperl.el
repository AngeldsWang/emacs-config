...
;; (lsp-register-client
;; (make-lsp-client :new-connection (lsp-stdio-connection '("node" "/Users/zhenjunwang/work/my/pl/PerlNavigator/server/out/server.js" "--stdio"))
...
(add-hook 'cperl-mode-hook
          (lambda ()
            ...
            ;; (setq lsp-pls-include '(
            ;;                         "/Users/zhenjunwang/.plenv/versions/5.32.1/lib/perl5/site_perl/5.32.1/darwin-2level"
            ;;                         "/Users/zhenjunwang/.plenv/versions/5.32.1/lib/perl5/site_perl/5.32.1"
            ;;                         "/Users/zhenjunwang/.plenv/versions/5.32.1/lib/perl5/5.32.1/darwin-2level"
            ;;                         "/Users/zhenjunwang/.plenv/versions/5.32.1/lib/perl5/5.32.1"
            ;;                         ))
            ))
;; (lambda() (split-string (shell-command-to-string "perl -e 'print join(\" \", @INC)'") " "))
